...
try {
    ...
    if (data.message == 'success'){
        toast.success(" User Updated SuCCESSFULIY !!!")
        navigate('/user/index')
        setLoader(false)
...
<Input value={user.name} errors={errors} name={'name'} type={'text'}  id={'name'} title= {'Name'} handelChange ={ handelChange} />
<Input  value={user.email} errors={errors} name={'email'} type={'email'}  id={'email'} title= {'Email'} handelChange ={ handelChange} />
<Input  value={user.password} errors={errors} name={'password'} type={'password'}  id={'password'} title= {'Password'} handelChange ={ handelChange} />
